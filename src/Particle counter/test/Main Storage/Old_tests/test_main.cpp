...
void MODBUS_CalcCRC(void);
void ConvSTtoTemperature(void);
void ConvSRHtoRelativeHumidity(void);
...
void OpenSD(File FileName) {
  if (FileName == SysData) {
    FileName = SD.open("SysData.txt", FILE_WRITE);  // Edit file name to contain date.
    if (!FileName) {
